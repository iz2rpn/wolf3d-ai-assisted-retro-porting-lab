...
- WL1 and WL6 ARMv5 soft-float cross-builds.
- Twenty-second QEMU no-keyboard smoke tests for both profiles.
- Qualitative physical LCD operation reported by the device owner.

## 0.1.0 - 2026-07-17

- Reconstructed a reproducible Wolf4SDL Z6S port from the recovered deployment.
- Added fixed full-screen presentation, keyboard/touch input, demo fallback,
  minimal audio, reversible SD startup, and build documentation.
